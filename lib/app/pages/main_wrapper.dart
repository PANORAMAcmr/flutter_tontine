...
_MainWrapperState mainWrapperState = _MainWrapperState();
...
class MainWrapper extends StatefulWidget {
  ...
  @override
  _MainWrapperState createState() {
    mainWrapperState = _MainWrapperState();
...
class _MainWrapperState extends State<MainWrapper> {
  ...
  setSelectedIndex(currentIndex){
    ...
    widget.statefulNavigationShell!.goBranch(currentIndex,
        initialLocation: currentIndex == widget.statefulNavigationShell!.currentIndex);
  }
}
